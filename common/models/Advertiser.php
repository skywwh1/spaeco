...
class Advertiser extends ActiveRecord implements IdentityInterface
{
     ...
     */
    public function getAdvEducations()
    {
        return $this->hasMany(AdvEducation::className(), ['adv_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getAdvExperiences()
    {
        return $this->hasMany(AdvExperience::className(), ['adv_id' => 'id']);
    }
