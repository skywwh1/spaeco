...
class CampaignSearch extends Campaign
{
    ...
    public function rules()
    {
        return [
            ...
            [['campaign_name', 'campaign_uuid', 'pricing_mode', 'payout_currency', 'device', 'platform', 'min_version', 'max_version', 'target_geo', 'traffic_source', 'kpi', 'note', 'others', 'preview_link', 'icon', 'package_name', 'app_name', 'app_size', 'category', 'version', 'app_rate', 'description', 'creative_link', 'creative_type', 'creative_description', 'carriers', 'conversion_flow', 'epc', 'track_way', 'track_link_domain', 'adv_link', 'other_setting', 'ip_blacklist', 'publisher'], 'safe'],
