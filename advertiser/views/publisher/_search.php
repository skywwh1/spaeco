...
/* @var $model advertiser\search\PublisherSearch */
...
<div class="publisher-search">
    ...
    <?php // echo $form->field($model, 'master_publisher') ?>
    ...
    <?php // echo $form->field($model, 'strong_category') ?>
    ...
    <?php // echo $form->field($model, 'name_card_path') ?>
