...
/* @var $experiences common\models\PubExperience[] */
/* @var $advEducations common\models\PubEducation[] */

$this->title = $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Publishers', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
unset($this->assetManager->getBundle('publisher\assets\AppAsset')->js[0]);
...
<div class="row">
    ...
    <div class="col-lg-8">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <?php if (isset($model->name_card_path)) { ?>
